...
\begin{etaremune}
    ...
    \item \textbf{M. Farias}, W. Martins, H. T. Kung, ``MDM: Manhattan Distance Mapping of DNN Weights for Parasitic-Resistance‑Resilient Memristive Crossbars'', \textit{in submission}.

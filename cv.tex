...
Current projects and other information can be found \href{https://www.matheussfarias.com/}{here}.

\vspace{.25cm}

\entry{2021--Present}{\textbf{Computing in Memory}}{\harv}{
	Working on the algorithmic level perspective to allow efficient deep neural networks under the crossbar architecture. Particularly interested in ways to avoid bottlenecks on the architecture such as energy consumption due to data conversions, wire resistance impact, sneak paths, and negative weight representation.
}
...
\begin{etaremune}
    ...
    \item \textbf{M. S. Farias}\co , H. T. Kung\co, “Applying Sorted Sectioning to Compute-in-Memory Crossbars for DNN Computations Reduces ADC Cost and Wire Resistance Impact”, submitted to the \textit{International Conference on Supercomputing 2023 (ICS'23)}.
...
\begin{itemize}[label={}]
    ...
    \item CS205 -- \textit{High Performance Computing} \hfill\textsc{Spring 2023}
\end{itemize}
...
\we{2016--2018}{\textbf{Espaço Diferencial}}{Co-Founder and Teacher}{
	Idealized the course, a non-profit school to support underpriviledge students in basic engineering classes. Managed the action strategy planning that turned to impact over 200 students with a team of 10 teachers. Taught Physics at the undergraduate level.
	}{Recife, Brazil}
...
\begin{itemize}
	\item Brazilian Team Leader of the International Young Physicists' Tournament in Pakistan
    \hfill\textsc{2023}
    ...
    \item Officer of the School of Engineering and Applied Sciences at the Harvard Brazilian Association
	\hfill\textsc{2021--2023}

    \item Judge for the International Young Physicists' Tournanment Brazil
	\hfill\textsc{2021--2023}
	\end{itemize}

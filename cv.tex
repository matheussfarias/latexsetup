...
\entry{2021--Present}{\textbf{EfficientAI/TinyML (Meta AI/AFRL collab)}}{\harv}{
	Working on the algorithmic-level to improve efficiency of deep neural network deployment in the compute-in-memory crossbar architecture. Particularly interested in reducing bottlenecks such as data conversions, nonidealities, programming time and weight mapping.
}
...
\begin{etaremune}
	...
	\item \textbf{M. Farias}, H. T. Kung, ``Efficient Reprogramming of Memristive Crossbars for DNNs: Weight Sorting and Bit Stucking'', \textit{in submission}.

...
\we{2021--present}{\textbf{\harv}}{Ph.D. in Electrical Engineering}{Focusing on machine learning, IoT and hardware design.}{Cambridge, MA}
...
\entry{2019-2020}{\textbf{Lock-in: Nano-Volt Signal Amplifier} (\href{https://www.cin.ufpe.br/~msf4/lockin.html}{link})}{\ufpe}{
	Design and optimization of a phase-sensitive lock-in amplifier circuit for the Magnetism and Magnetic Materials' group led by the former Minister of Science and Technology of Brazil Prof.\ Dr.\ Sergio Rezende to be used for investigating magnetic properties of thin films such as IrMn/Py using MOKE technique.
}
...
\entry{Fall 2020}{ES456 -- \textbf{Machine Learning} -- Teaching Assistant}{\ufpe}{
	I conducted my own activities and lectures off of my own syllabus. Helped the students developing projects and graded work.
	}
